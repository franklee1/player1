...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Big Box Coin 2018 really grat";
        CTransaction txNew;
        txNew.nTime = 1525760708;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525760708;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 397722 : 397722;
        ...
        assert(block.hashMerkleRoot == uint256("0x92102f6cbbf80e3016030ce3f17b8550e5795f7e93976dc384b33de04f2c0c65"));
